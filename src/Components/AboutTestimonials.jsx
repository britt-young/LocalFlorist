  ...
  return (
    <div className="flex flex-col justify-center items-center bg-white py-20">
      <div className="text-center">
        <h2 className="text-black">Our Community</h2>
        <h3 className="text-primary">
          here's what customers are saying about Local
        </h3>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-7xl mx-5 lg:mx-0">
        ...
        <div className="text-center bg-tertiary px-5 pb-10 shadow-md items-center flex flex-col transition-transform duration-700 hover:scale-105 ease-in-out">
          ...
          <p className="text-gray-600 px-2">
           Local Florist brought my wedding bouquet vision to life! Our consultation was so helpful, we designed my bouquet during our call and the final bouquet was even better than I imagined!
          </p>
        </div>
      </div>
       <Link
